/**
 * gtcrn_linux.c — GTCRN Linux 侧降噪主程序 (v22 — linux_api16, 前置AGC + dump)
 * ===========================================================================
 * 前置AGC管线 + SIGUSR1/SIGUSR2 波形抓取
 *
...
int main(int argc, char **argv) {
    ...
    if (measure_mode) {
        fprintf(stderr, "GTCRN v22 — measure mode (no AGC)\n");
        ...
        fprintf(stderr, "GTCRN v22 — test mode (AGC→NR)\n");
        ...
        fprintf(stderr, "GTCRN v22 — BYPASS\n");
        ...
        fprintf(stderr, "GTCRN v22 — iccom (pre-AGC, state_flag=3)\n");
